SELECT hd_ticket.OWNER_ID AS owner, user.USER_NAME, COUNT(hd_ticket.ID) AS total, HD_STATUS.NAME AS STATUS, MONTH(hd_ticket.TIME_CLOSED) AS MONTH, YEAR(hd_ticket.TIME_CLOSED) AS YEAR
FROM HD_TICKET
